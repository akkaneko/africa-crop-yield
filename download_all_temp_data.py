...
for country_key,val in fusion_table_dict.items():
    ...
    imgcoll = ee.ImageCollection('MODIS/006/MOD11A2').filterDate(start_date, end_date + '-12-31').sort('system:time_start').filterBounds(ee.Geometry.Rectangle(-22, 38, 60, -38))
    ...
    for name in feature_names:
        ...
        export_oneimage(img.clip(feature), 'africa-yield', "temp_" + country_key + "_" + name, scale, crs)
